            ...
            <div className="w-4/5 flex justify-center pt-5  mx-auto ">
                <div className='w-full flex flex-col md:flex-row items-start  md:justify-between py-10 text-gray-500'>
                    <div className="flex-1">
                        <h2 className="font-semibold text-xl text-gray-700 mb-3">Location</h2>
                    ...
                    <div className="flex-1">
                        <h2 className="font-semibold text-xl text-gray-700 mb-3">Sitemap</h2>
                        <ul>
                    ...
                    <div className="flex-1">
                        <h2 className="font-semibold text-xl text-gray-700 mb-3">Blog</h2>
                        <ul>
                            <li>Right Blog</li>
                            <li>Left Blog</li>
                            <li>Bottom Blog</li>
                    ...
                    <div className="flex-1">
                        <h2 className="font-semibold text-xl text-gray-700 mb-3">Appointment</h2>
